        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="collections container">
                    ...
                    $front_theme = theme_info(my_config('front_theme', NULL, my_config('theme')))?>
                    ...
                    <div class="row border p-1 rounded text-info font-weight-bold small">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="text-muted"><?=$front_theme['name'];?></div>
                            <div>Author: <span class="text-muted"><?=$front_theme['author'];?></span></div>
                            <div>Version: <span class="text-muted">v<?=$front_theme['version'];?></span></div>
                            <div>Available For: <span class="text-muted"><?=$front_theme['availability'];?></span></div>
                            <div>Stable Modules: <span class="text-muted"><?=implode(', ', $front_theme['stable']);?></span></div>
                        </div> 
                    </div>
                    ...
                    <div class="row p-3 mb-3" id="design_block">
                        ...
                        <div class="form-group col-md-4">
                            <div class="form-group">
                                <label class="text-info" for="front_theme">Front Theme</label>
                                <?=select_theme(
                                fetch_themes('front'),
                                'class="form-control" name="value[front_theme]"',
                                set_value('value[front_theme]', my_config('front_theme', NULL, my_config('theme'))));
                                ?>
                                <small class="text-muted">
                                Sets the front theme for the site.
                                </small>
                                <?= $errors->showError('value.front_theme', 'my_single_error'); ?>
                            </div>
                        </div> 
