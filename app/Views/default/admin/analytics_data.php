...
if (!empty($analytics['referrer'])) 
{
    ...
    $analytics['referrer'] = $analytics['referrer'] ? anchor(prep_url($analytics['referrer']), prep_url($referrer??$analytics['referrer']) . "...", ['data-toggle'=>'tooltip', 'title'=>prep_url($analytics['referrer'])]) : null;
