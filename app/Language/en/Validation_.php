...
return [
   ...
   'invalidTemplate'       => '{0} is not a valid Validation template.',
	...
	// Rule Messages
   'accept_terms'          => 'You must read and accept our {field}.',
   ...
   'in_use'                => 'The {field} you provided is already in use.',
   ...
   'regex_match'           => '{value} is not an allowed {field} format.',
   ...
   'validate_login'        => 'This {field} does not exist.',
   'validate_password'     => 'The {field} you entered is invalid.',
